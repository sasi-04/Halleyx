...
import { LayoutPanelLeft, History, Workflow, User, LogOut, FilePlus, FolderOpen, Bell, ClipboardCheck, Users, UserPlus } from "lucide-react";
import { useTheme } from "../theme/ThemeProvider";

const ROLES = ["EMPLOYEE", "MANAGER", "FINANCE", "HR", "CEO", "ADMIN"] as const;
type Role = (typeof ROLES)[number];

const navItems: { href: string; label: string; icon: any; roles: readonly Role[] }[] = [
  ...
  { href: "/hr/dashboard", label: "HR Dashboard", icon: UserPlus, roles: ["HR", "ADMIN"] },
  { href: "/ceo/dashboard", label: "CEO Dashboard", icon: ClipboardCheck, roles: ["CEO", "ADMIN"] },
  { href: "/requests/create", label: "Create Request", icon: FilePlus, roles: ["EMPLOYEE", "HR", "ADMIN"] },
  { href: "/requests", label: "My Requests", icon: FolderOpen, roles: ["EMPLOYEE", "HR", "ADMIN"] },
